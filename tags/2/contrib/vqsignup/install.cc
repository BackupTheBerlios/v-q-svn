...
#undef c_vq
    ...
    c(conf_cgi_bin.c_str(),"vqsignup","vqsignup",06555,conf_vq_uid_i,conf_vq_gid_i);
    
    h(conf_xslt_dir.c_str(), 0755, conf_vq_uid_i, conf_vq_gid_i);
    c(conf_xslt_dir.c_str(), "vqsignup.xslt", "vqsignup.xslt", 0644, conf_vq_uid_i, conf_vq_gid_i);
#undef d_vq
}
