...
#undef c_vq
#define c_vq(x,m) do { \
		c(((string)"conf/"+x).c_str(),((string)"etc/vqwww/"+x+".dist").c_str(),m,ac_vq_uid.val_int(),ac_vq_gid.val_int(),true); \
		c(((string)"conf/"+x).c_str(),((string)"etc/vqwww/"+x).c_str(),m,ac_vq_uid.val_int(),ac_vq_gid.val_int(),false); \
} while(0)
	c_vq("locales", 0644);
#undef c_vq
#define c_vq(x,m) do { \
    ...
    c_vq("vqwww.pl_PL.xml", 0644);
    c_vq("vqwww.en_US.xml", 0644);
    c_vq("credirmod.xslt", 0644);
    c_vq("credirmod.pl_PL.xml", 0644);
    c_vq("credirmod.en_US.xml", 0644);
    c_vq("cpassmod.xslt", 0644);
    c_vq("cpassmod.pl_PL.xml", 0644);
    c_vq("cpassmod.en_US.xml", 0644);
    c_vq("cautorespmod.xslt", 0644);
    c_vq("cautorespmod.pl_PL.xml", 0644);
    c_vq("cautorespmod.en_US.xml", 0644);
    c_vq("cloghistmod.xslt", 0644);
    c_vq("cloghistmod.pl_PL.xml", 0644);
    c_vq("cloghistmod.en_US.xml", 0644);
#undef c_vq
...
#define c_vq(x) c(x,((string)"lib/vqwww/"+x).c_str(),0644,ac_vq_uid.val_int(),ac_vq_gid.val_int())
    c_vq("libsess.so.4.0");
    c_vq("libvqwww_conf.a");
    sl("libsess.so.4.0", "lib/vqwww/libsess.so", true);
#undef c_vq
    return 0;
} 
