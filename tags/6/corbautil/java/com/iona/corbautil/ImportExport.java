...
public class ImportExport
{
     ...
     */
    private static NamingContext contactNS(org.omg.CORBA.ORB orb)
	...
	try {
		...
		throw new ImportExportException(
			"resolve_initial_references(\"NameService\") failed: "
			+ ex);
	}
	...
	//--------
	// Convert "name_service#..." into NameComponent[] format
	//--------
	name = instructions.substring(NS_PREFIX.length());
	nsName = null;
	nsName = NsStringToName(name);
	if (nsName == null) {
