 ...
 * this interface with a class called com.acme.MyAlgorithm. Then, if you
 * specify <code>"java_class#com.acme.MyAlgorithm"</code> as the
 * instructions, your implementation class will be dynamically loaded and
 * <code>importObjRef()</code> and <code>exportObjRef()</code> will be
 * invoked upon it.
 */
