 ...
 implements com.foo_baz.v_q.iloggerOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("rm_all", new java.lang.Integer (12));
    _methods.put ("rm_by_dom", new java.lang.Integer (13));
    _methods.put ("rm_by_user", new java.lang.Integer (14));
  }
