...
/**
* com/foo_baz/v_q/iauthPackage/domain_infoHelper.java .
...
{
  private static String  _id = "IDL:vq/iauth/domain_info:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (com.foo_baz.v_q.iauthPackage.domain_infoHelper.id (), "domain_info", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static com.foo_baz.v_q.ivqPackage.domain_info read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = com.foo_baz.v_q.ivqPackage.domain_infoHelper.read (istream);
    return value;
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.foo_baz.v_q.ivqPackage.domain_info value)
  {
    com.foo_baz.v_q.ivqPackage.domain_infoHelper.write (ostream, value);
  }
