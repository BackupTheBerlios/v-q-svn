...
/**
* com/foo_baz/v_q/iauthPackage/user_conf_typeHelper.java .
...
{
  private static String  _id = "IDL:vq/iauth/user_conf_type:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (com.foo_baz.v_q.iauthPackage.user_conf_typeHelper.id (), "user_conf_type", __typeCode);
    }
    return __typeCode;
  }
