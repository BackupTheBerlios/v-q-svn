...
/**
* com/foo_baz/v_q/iauthPackage/user_infoHelper.java .
...
{
  private static String  _id = "IDL:vq/iauth/user_info:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (com.foo_baz.v_q.iauthPackage.user_infoHelper.id (), "user_info", __typeCode);
    }
    return __typeCode;
  }
  ...
  public static com.foo_baz.v_q.ivqPackage.user_info read (org.omg.CORBA.portable.InputStream istream)
  {
    ...
    value = com.foo_baz.v_q.ivqPackage.user_infoHelper.read (istream);
    return value;
  }

  public static void write (org.omg.CORBA.portable.OutputStream ostream, com.foo_baz.v_q.ivqPackage.user_info value)
  {
    com.foo_baz.v_q.ivqPackage.user_infoHelper.write (ostream, value);
  }
